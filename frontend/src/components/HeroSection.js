    ...
    <section className="relative min-h-[55vh] flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center animate-fade-in">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-4 gradient-text animate-slide-up">
            MovieMania
          </h1>
          
          <p className="text-lg md:text-xl text-white/80 mb-6 animate-slide-up" style={{ animationDelay: '0.1s' }}>
            Dive into Cinematic Worlds
          </p>
          <div className="flex justify-center mb-8 animate-slide-up" style={{ animationDelay: '0.15s' }}>
            <span className="glass-strong px-4 py-2 rounded-full text-white/80 text-sm md:text-base">
              Bengaluru • 12.9716° N, 77.5946° E
            </span>
          </div>
          
          <div className="flex justify-center space-x-6 mb-10 animate-slide-up" style={{ animationDelay: '0.2s' }}>
